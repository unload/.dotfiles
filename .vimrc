...
"
"   Name: Architect
"   Organizations: Riseup, Rootd It, Rapid7
"   Email: t3h4rch1t3ct@riseup.net
"   Rapid7: architect-r7
"   gpg --recv-keys 8FA00C90
"
"   You can find me at irc.rootd.it +6697
" }
...
" Format {
    ...
    autocmd FileType ruby set shiftwidth=2 tabstop=2 softtabstop=2 textwidth=78
    autocmd FileType ruby set expandtab
    autocmd FileType ruby hi BogusWhitespace ctermbg=darkgreen guibg=darkgreen
    autocmd FileType ruby match BogusWhitespace /\s\+$\|^\t\+ \+\|^ \+\t*/
